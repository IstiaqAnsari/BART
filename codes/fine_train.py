...
from dataloader import get_dataloaders_fine_tune, get_dataloaders_gold_fine_tune
...
def train(args):
    ...
    if(args.stage == "Synthetic"):
        train_dataloader, valid_dataloader = get_dataloaders_fine_tune(vocab_size = args.vs, batch_size = args.batch_size, prototype=args.proto)
    else:
        train_dataloader, valid_dataloader = get_dataloaders_gold_fine_tune(vocab_size = args.vs, batch_size = args.batch_size, prototype=args.proto)   
...
if __name__ == '__main__':
    ...
    parser.add_argument('--key', default='fine_tune', type=str, help='name of experiment')
